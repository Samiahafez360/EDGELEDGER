...
void print_vk_to_stream(r1cs_ppzksnark_verification_key<ppT> vk, stringstream vk_data)
{
  //ofstream vk_data;
...
template<typename ppT>
void print_proof_to_file(r1cs_ppzksnark_proof<ppT> proof, stringstream proof_data)
{
  ofstream proof_data;
